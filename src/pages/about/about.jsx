...
export const About = () => {
	return (
		<div>
			...
			<h2 className="text-xl md:text-2xl font-bold text-indigo-700 dark:text-indigo-300">The Break</h2>
			...
			<p className="text-lg mt-3 dark:text-slate-300">
				In 2017, I decided to join the <span className="text-indigo-700 dark:text-indigo-300">military</span>, convinced that it was my true
			...
			<h2 className="text-xl md:text-2xl font-bold mt-4 text-indigo-700 dark:text-indigo-300">Transitioning into tech</h2>
			...
			<p className="text-lg mt-3 dark:text-slate-300">
				...
				and embark on a <span className="text-indigo-700 dark:text-indigo-300">new adventure.</span>
			</p>
			<p className="text-lg mt-3 dark:text-slate-300">
				In addition to my self-taught programming training, I decided to take a
				step forward in my career and completed a <span className="text-indigo-700 dark:text-indigo-300">full stack web development
				bootcamp.</span>
                <br /><br />
			...
			<p className="text-lg mt-3 dark:text-slate-300">
				But not content with this, I decided to also do a <span className="text-indigo-700 dark:text-indigo-300">higher degree in web
				development which I am currently studying.</span>
			</p>
			<h2 className="text-xl md:text-2xl font-bold mt-4 text-indigo-700 dark:text-indigo-300">Now</h2>
			<p className="text-lg mt-3 dark:text-slate-300">
